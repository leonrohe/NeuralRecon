...
FORCE_CUDA=1 conda run -n neucon pip install -vv \
  git+https://github.com/mit-han-lab/torchsparse.git@48cc7e23784d35e67163f61b9312df138853025e

echo "Starting NeuralRecon"
exec stdbuf -oL -eL conda run -n neucon python -u /app/scripts/neucon_main.py --cfg /app/configs/neucon.yaml
